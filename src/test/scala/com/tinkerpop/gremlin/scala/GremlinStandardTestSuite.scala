...
object Tests {
  ...
  abstract class ScalaDedupTest extends DedupTest with StandardTest {
  ...
  abstract class ScalaFilterTest extends FilterTest with StandardTest {
    ...
    //override def get_g_v1_out_filterXage_gt_30X: Traversal[Vertex, Vertex] = ???
  ...
  abstract class ScalaExceptTest extends ExceptTest with StandardTest {
