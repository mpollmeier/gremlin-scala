...
object Constructor extends LowPriorityConstructorImplicits {
  type Aux[DomainType, Labels <: HList, GraphTypeOut, StepsTypeOut] =
...
trait LowPriorityConstructorImplicits extends LowestPriorityConstructorImplicits {
  ...
  def forDomainNode[DomainType <: DomainRoot,
                    Labels <: HList,
  ...
  implicit def forList[A, AGraphType, Labels <: HList, AStepsType](
  ...
  implicit def forSet[A, AGraphType, Labels <: HList, AStepsType](
      implicit aConverter: Converter.Aux[A, AGraphType]) =
